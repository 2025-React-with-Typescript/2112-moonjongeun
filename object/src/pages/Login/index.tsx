      ...
      <div className="flex h-screen w-full bg-[#fff] m-auto items-center justify-center">
        <div className="flex flex-col items-center border-1 border-[#ccc] w-140 h-115 rounded-lg p-8">
          ...
          <div className="flex flex-col gap-3 pt-12">
            <input type="text" className="flex p-3 w-105 h-12 items-center text-sm font-md text-[#717171] border-1 rounded-sm border-[#0D55D9]" placeholder="아이디" / >
            <input type="text" className="flex p-3 w-105 h-12 items-center text-sm font-md text-[#717171] border-1 rounded-sm border-[#0D55D9]" placeholder="비밀번호" / >
          </div>
